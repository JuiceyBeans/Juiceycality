...
public class JCBlocks {
    //Casings
    public static BlockEntry<Block> BiologicallySterileCasing = createCasingBlock("biologically_sterile_casing", JCMain.id("block/casings/solid/biologically_sterile_machine_casing"));
    ...
    // Glass casings
    public static BlockEntry<Block> BorosilicateGlass = createGlassCasingBlock("borosilicate_tempered_glass", JCMain.id("block/casings/transparent/borosilicate_tempered_glass"), () -> RenderType::translucent);
    public static BlockEntry<Block> NickelGlass = createGlassCasingBlock("nickel_tempered_glass", JCMain.id("block/casings/transparent/nickel_tempered_glass"), () -> RenderType::translucent);
    public static BlockEntry<Block> ChromeGlass = createGlassCasingBlock("chrome_tempered_glass", JCMain.id("block/casings/transparent/chrome_tempered_glass"), () -> RenderType::translucent);
    public static BlockEntry<Block> OsmiridiumGlass = createGlassCasingBlock("osmiridium_tempered_glass", JCMain.id("block/casings/transparent/osmiridium_tempered_glass"), () -> RenderType::translucent);
    ...
    public static BlockEntry<Block> createCasingBlock(String name, BiFunction<BlockBehaviour.Properties, IRenderer, ? extends RendererBlock> blockSupplier, ResourceLocation texture, NonNullSupplier<? extends Block> properties, Supplier<Supplier<RenderType>> type) {
        ...
        return JC_REGISTRATE.block(name, p -> (Block) blockSupplier.apply(p,
    ...
    private static BlockEntry<Block> createMachineCasingBlock(String name, int tier) {
        ...
        BlockEntry<Block> entry = JC_REGISTRATE.block(name, p -> (Block) new RendererBlock(p,
