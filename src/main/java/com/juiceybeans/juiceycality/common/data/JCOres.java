...
import static com.juiceybeans.juiceycality.common.data.JCMaterials.GoldAlloy;
...
public class JCOres {
    ...
    public static final GTOreDefinition RICH_GOLD_VEIN = GTOres.create(ResourceLocation.tryParse("rich_gold_vein"), vein -> vein
            ...
            .veinedVeinGenerator(generator -> generator
                    ...
                    .oreBlock(new VeinedVeinGenerator.VeinBlockDefinition(JCMaterials.PreciousMetal, 2))
